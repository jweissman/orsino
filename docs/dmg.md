...
| Alignment | Terrain | Domain | Climate | Race Association |
|-----------|---------|--------|---------|------------------|
| Neutral Good | Forest | Life | Pleasant | Fae |
...
| Alignment | Terrain | Domain | Climate | Race Association |
|-----------|---------|--------|---------|------------------|
| Neutral Evil | Swamp | Death | Foggy | -- |
...
| Alignment | Terrain | Domain | Climate | Race Association |
|-----------|---------|--------|---------|------------------|
| Lawful Evil | Mountain | War | Sulfurous clouds and ash | -- |
...
| Alignment | Terrain | Domain | Climate | Race Association |
|-----------|---------|--------|---------|------------------|
| Lawful Evil | Cave | Knowledge | Permanently overcast | -- |
...
| Alignment | Terrain | Domain | Climate | Race Association |
|-----------|---------|--------|---------|------------------|
| Chaotic Neutral | Desert | Chaos | Windy | -- |
...
| Alignment | Terrain | Domain | Climate | Race Association |
|-----------|---------|--------|---------|------------------|
| Lawful Neutral | Mountain | Order | Clear skies | -- |
...
| Alignment | Terrain | Domain | Climate | Race Association |
|-----------|---------|--------|---------|------------------|
| Chaotic Evil | Cave | Trickery | Howling winds | -- |
...
| Alignment | Terrain | Domain | Climate | Race Association |
|-----------|---------|--------|---------|------------------|
| Lawful Good | Snow | War | Snowstorms | Dwarf |
...
| Alignment | Terrain | Domain | Climate | Race Association |
|-----------|---------|--------|---------|------------------|
| Neutral Neutral | Forest | Storms | Thunderstorms | Elf |
...
| Consumable | Description | Effects |
|------------|-------------|---------|
...
| Wand of Wonder | _A whimsical wand that produces random magical effects when used._ | Apply one of the following random effects to 5 random enemies: Cast ability Missile (Deal 1d3 + floor(#level/3) force damage to 2 + round(#level/2) random enemies.) on 5 random enemies; Cast ability Fireball (Deal 6d6 fire damage to all enemies.) on 5 random enemies; Cast ability Lightning Bolt (Deal 1d8 electric damage to 2 random enemies; 2 random enemies suffer Paralyzed (Cannot take actions, degrade Strength by 5, degrade Dexterity by 5).) on 5 random enemies; Cast ability Cone Of Cold (Deal 5d6 cold damage to =1d6 + floor(#level / 2) random enemies.) on 5 random enemies; Cast ability Invisibility (Grant yourself or an ally Invisible (Invisible, On attack, Remove Invisible from self, On offensive casting, Remove Invisible from self).) on 5 random enemies; Cast ability Flight (Grant yourself or an ally Flight (Improve evasion by 20, improve AC by 5).) on 5 random enemies; Cast ability Heal (Heal an ally 1d4 HP.) on 5 random enemies; Cast ability Summon Monster (Summon of class =oneOf(beast, fey) monster.) on 5 random enemies; Cast ability Summon Elemental (Summon of class Elemental monster.) on 5 random enemies. |


## Status Effects

| Status Effect | Description | Details |
|---------------|-------------|---------|
...
| Barkskin |  | Improve AC by 2 |
| Battlecry | _Letting out a fierce battlecry to intimidate foes._ | Add =1d3 to bonus damage |
| Bear's Endurance |  | Improve Constitution by 2, Gain 15 temporary HP |
| Bleeding |  | On turn end, Deal 1d2 bleed damage to self |
| Blessed |  | Improve to hit by 1, improve bonus damage by 1 |
| Blinded |  | Degrade to hit by 4, degrade evasion by 10, degrade all rolls by 2 |
| Blood Frenzy | _Entering a frenzied state after slaying an enemy._ | Improve to hit by 2, improve bonus damage by 2, degrade AC by 2 |
| Blurred |  | Improve Save versus Magic by 2, improve AC by 1, improve evasion by 10 |
| Bull's Strength |  | Improve Strength by 2 |
| Burning |  | On turn end, Deal 1d3 fire damage to self |
| Calm |  | Immunity to Fear, Immunity to Insanity, improve to hit by 1, improve Save versus Will by 2 |
| Cat's Grace |  | Improve Dexterity by 2, improve evasion by 5 |
| Chanting |  | Improve all saves by 1, improve bonus spell DC by 1, improve bonus spell slots by 1, improve to hit by 2, On turn end, Heal allies 1d3 + #level HP |
| Charmed | _Exuding an aura of helpfulness._ | Allegiance changed |
| Clarity |  | Improve all rolls by 2, Immunity to Charm |
| Confused |  | Actions are random |
| Courage |  | Improve all saves by 2, Immunity to Fear |
| Cursed | _Afflicted by a malevolent doom._ | Degrade all stats by 1 |
| Deafened |  | 50% resistance to Sonic, degrade bonus damage by 2, degrade AC by 2, degrade to hit by 2, degrade all saves by 1 |
| Defending | _Adapting a defensive stance._ | Improve AC by 2 |
| Disabled |  | Cannot take actions, Status effects do not expire |
...
| Eagle's Splendor |  | Improve Charisma by 2, improve to hit by 1 |
| Engulfed |  | On turn end, Deal 2d6 acid damage to self, Cannot take actions |
...
| Giant's Strength |  | Improve Strength by 6, add =1d3 to bonus melee damage |
...
| Infected |  | Degrade Constitution by 1, degrade all saves by 2, degrade to hit by 1, degrade bonus damage by 1 |
| Insane |  | Actions are random, degrade all rolls by 1, degrade Save versus Will by 2 |
| Insight |  | Improve all saves by 2, improve bonus spell DC by 1 |
| Inspired |  | Improve to hit by 2, Gain 5 temporary HP, improve all saves by 1 |
| Invisible | _Unable to be seen by enemies._ | Invisible, On attack, Remove Invisible from self, On offensive casting, Remove Invisible from self |
| Invulnerable | _Temporarily immune to harm._ | Untargetable |
| Ironskin |  | Improve AC by 5 |
| Keen Senses |  | Improve to hit by 2, improve evasion by 5, improve bonus damage by 1, improve all saves by 1 |
| Lightproof |  | 50% resistance to Radiant |
| Mage-Armored |  | Improve AC by 4, Gain 20 temporary HP |
| Mageproof |  | 50% resistance to Force, improve Save versus Magic by 2 |
| Meditating |  | Cannot take actions, improve Save versus Magic by 2, 25% resistance to Force, On turn end, Heal self 1d2 + #level HP |
| Migraine |  | 200% vulnerability to Radiant, 200% vulnerability to Sonic |
| Mind Blank |  | 50% resistance to Psychic, improve Save versus Will by 2, Immunity to Charm, Immunity to Insanity, Immunity to Fear, Immunity to Sleep |
| Minor Warded |  | Improve Save versus Magic by 1, 25% resistance to Force, Gain =7 + #level temporary HP |
...
| Paralyzed |  | Cannot take actions, degrade Strength by 5, degrade Dexterity by 5 |
...
| Poison |  | On turn end, Deal 1d4 true damage to self |
| Praying |  | Improve to hit by 1, improve all saves by 2, improve bonus healing by 2, Gain 10 temporary HP |
| Prone | _Lying on the ground, vulnerable to attacks._ | Cannot take actions, degrade Dexterity by 2 |
| Protected |  | 50% resistance to Necrotic, Immunity to Charm |
| Raging | _Utterly overcome with fury._ | Improve to hit by 1, improve bonus damage by 2, degrade AC by 3 |
| Reckless | _Throwing caution to the wind._ | Degrade to hit by 2, degrade AC by 2 |
| Reflect |  | Add 50% to damage reflection percent |
| Riposting | _Punishing missed attacks._ | Improve evasion by 3, degrade AC by 1, On miss received, Attack attacker |
| Scalded |  | Degrade all rolls by 1 |
| Scaleskin |  | Improve AC by 8, 25% resistance to Fire |
| Shielded |  | Improve AC by 1, Gain 10 temporary HP, improve Save versus Magic by 1 |
| Silence |  | Cannot cast spells |
| Slimed |  | 200% vulnerability to Acid |
| Slow |  | Degrade Dexterity by 5, degrade initiative by 10, degrade attacks per turn by 1 |
| Soundproof |  | 50% resistance to Sonic |
| Spellturn | _Reflecting spells back at their casters._ | Add 50% to spell reflection chance |
| Steelskin |  | Improve AC by 10, 50% resistance to Piercing, 50% resistance to Slashing |
| Stoneskin |  | Improve AC by 3 |
| Stormproof |  | 50% resistance to Lightning |
| Stunned |  | Cannot take actions, degrade all rolls by 2 |
| Sunmarked |  | Degrade Save versus Magic by 1, 25% vulnerability to Fire, 25% vulnerability to Radiant, On attacked, Deal 1d4 radiant damage to self |
| Taunted | _Compelled to attack the taunter if able._ | Next target forced to be you |
| Thirst |  | Degrade Constitution by 2, degrade all saves by 1, 100% vulnerability to Fire |
| Time Stopped | _Completely outside the flow of time._ | Improve extra turns by 3, Does not trigger reactions |
| Time Walk | _Temporarily stepping outside the flow of time._ | Untargetable, improve AC by 5, improve evasion by 20, improve attacks per turn by 4 |
...
|------|-------------|---------|
| Acid Pool | _A pool of acid forms_ | Deal 3d6 acid damage to target |
| Acid Rain | _A rain of acid pours down_ | Deal 6d6 acid damage to target |
| Acid Spray | _A spray of acid burns_ | Deal 2d6 acid damage to target |
| Apocalypse | _Apocalyptic energies ravage the area_ | Deal 20d6 true damage to target |
| Blinding Flash | _A flash of blinding light erupts_ | Target suffers Blinded (Degrade to hit by 4, degrade evasion by 10, degrade all rolls by 2) |
| Blinding Rune | _A rune glows with blinding energy_ | Target suffers Blinded (Degrade to hit by 4, degrade evasion by 10, degrade all rolls by 2) |
| Bone Spear | _A spear of bone shoots out_ | Deal 6d6 piercing damage to target |
| Chaos Rune | _A rune glows with chaotic energy_ | Target suffers Insane (Actions are random, degrade all rolls by 1, degrade Save versus Will by 2) |
| Concealed Blade | _A concealed blade swings out_ | Deal 1d8 slashing damage to target |
| Confusion Gas | _A gas of confusion spreads_ | Deal 1d4 psychic damage to target; Target suffers Confused (Actions are random) |
| Confusion Rune | _A rune glows with confusing energy_ | Target suffers Confused (Actions are random) |
| Cursed Mark | _A cursed mark appears_ | Target suffers Cursed (Degrade all stats by 1) |
| Darkness Field | _A field of magical darkness envelops the area_ | Target suffers Blinded (Degrade to hit by 4, degrade evasion by 10, degrade all rolls by 2) |
| Darkness Rune | _a rune glows with dark energy_ | Target suffers Blinded (Degrade to hit by 4, degrade evasion by 10, degrade all rolls by 2) |
| Death Word | _A word of death is spoken_ | Deal 5d6 necrotic damage to target |
| Dimensional Shred | _Dimensions tear apart_ | Deal 6d6 force damage to target |
| Disease Cloud | _A virulent disease spreads_ | Target suffers Diseased (Degrade Constitution by 2, degrade all saves by 2, On turn end, Deal 1d4 necrotic damage to self) |
| Divine Light | _A beam of harsh judgment shines down_ | Deal 10d6 radiant damage to target |
| Doom Rune | _A rune glows with ominous energy_ | Target suffers Doomed (Degrade all stats by 4 for 3 turns) |
| Electrified Floor | _The floor becomes electrified_ | Deal 3d6 lightning damage to target |
| Energy Burst | _A burst of energy explodes_ | Deal 10d6 force damage to target |
| Energy Drain | _Energy is drained away_ | Target suffers Fatigued (Degrade Strength by 1, degrade Dexterity by 1, degrade Constitution by 1, degrade all rolls by 1) |
| Entangling Vines | _Vines erupt from the ground_ | Target suffers Entangled (Degrade Dexterity by 5, degrade to hit by 2, degrade evasion by 5, degrade initiative by 5) |
| Falling Rocks | _Rocks fall from above_ | Deal 3d6 bludgeoning damage to target |
| Falling Spikes | _Spikes fall from above_ | Deal 4d6 piercing damage to target |
| Fear Gas | _A noxious cloud fills the area_ | Deal 1d4 psychic damage to target; Target suffers Frightened (Degrade to hit by 2, degrade initiative by 5, degrade all rolls by 1, degrade all saves by 2) |
| Fear Rune | _A rune glows with fearful energy_ | Target suffers Frightened (Degrade to hit by 2, degrade initiative by 5, degrade all rolls by 1, degrade all saves by 2) |
| Flame Burst | _A burst of flame erupts_ | Deal 2d6 fire damage to target |
| Flame Jet | _A jet of flame shoots out_ | Deal 3d6 fire damage to target |
| Flame Tornado | _A tornado of flame swirls_ | Deal 8d6 fire damage to target |
| Flame Wave | _A wave of flame surges_ | Deal 5d6 fire damage to target |
| Flame Whip | _A whip of flame lashes out_ | Deal 4d6 fire damage to target |
| Force Blast | _A blast of force energy erupts_ | Deal 8d6 force damage to target |
| Force Field | _A force field surrounds the area_ | Deal 3d6 force damage to target |
| Force Push | _A forceful push knocks you back_ | Target suffers Prone (Cannot take actions, degrade Dexterity by 2) |
| Force Spike | _A spike of force energy shoots out_ | Deal 4d6 force damage to target |
| Freezing Blast | _A sudden blast of freezing air chills_ | Deal 2d6 cold damage to target; Target suffers Slow (Degrade Dexterity by 5, degrade initiative by 10, degrade attacks per turn by 1) |
| Freezing Rune | _A rune glows with icy energy_ | Deal 3d6 cold damage to target |
| Freezing Spray | _A spray of freezing air chills_ | Deal 4d6 cold damage to target |
| Frost Bite | _A bite of frost chills deeply_ | Deal 7d6 cold damage to target |
| Frost Nova | _A nova of frost erupts_ | Deal 5d6 cold damage to target |
| Gate Of Shadows | _A gate to the shadow realm opens_ | Planeshift target to Cthelll |
| Gravity Well | _A well of gravity pulls inward_ | Target suffers Agony (Degrade Intelligence by 1, degrade Wisdom by 1, On turn end, Deal 2d4 necrotic damage to self) |
| Hateful Whisper | _A hateful whisper fills the mind_ | Target suffers Frightened (Degrade to hit by 2, degrade initiative by 5, degrade all rolls by 1, degrade all saves by 2); Target suffers Mocked (Degrade to hit by 1, degrade bonus damage by 1, degrade all saves by 1) |
| Hidden Dart | _A hidden dart shoots out_ | Deal 1d6 piercing damage to target |
| Holy Burst | _A burst of holy energy explodes_ | Deal 5d6 radiant damage to target |
| Ice Spikes | _Spikes of ice shoot up_ | Deal 6d6 cold damage to target |
| Lava Spray | _A spray of lava erupts_ | Deal 6d6 fire damage to target |
| Life Drain | _Life energy is drained_ | Deal 5d6 necrotic damage to target |
| Lightning Bolt | _A bolt of lightning strikes down_ | Deal 2d6 lightning damage to target |
| Lightning Wave | _A wave of lightning surges_ | Deal 4d6 lightning damage to target |
| Maze Rune | _A rune glows with maze-like energy_ | Target suffers In Maze (Cannot take actions, Untargetable) |
| Mental Shock | _A shock of mental energy assaults the mind_ | Deal 6d6 psychic damage to target |
| Mind Fog | _A fog of confusion clouds the mind_ | Target suffers Confused (Actions are random); Target suffers Distracted (Degrade to hit by 1, degrade bonus damage by 1, degrade evasion by 5) |
| Mind Spike | _A spike of mental energy pierces the mind_ | Deal 8d6 psychic damage to target; Target suffers Stunned (Cannot take actions, degrade all rolls by 2) |
| Necrotic Aura | _An aura of necrotic energy radiates_ | Deal 3d6 necrotic damage to target |
| Necrotic Burst | _A burst of necrotic energy explodes_ | Deal 4d6 necrotic damage to target |
| Necrotic Touch | _A necrotic touch drains life_ | Deal 2d6 necrotic damage to target |
| Necrotic Wave | _A wave of necrotic energy washes over_ | Deal 8d6 necrotic damage to target |
| Petrification Rune | _A rune glows with petrifying energy_ | Target suffers Petrified (Cannot take actions, Immunity to Fear, Immunity to Charm, Immunity to Stun, Immunity to Sleep, Immunity to Poison, Immunity to Disease) |
| Pit Opening | _The ground gives way_ | Deal 2d6 bludgeoning damage to target; Target suffers Prone (Cannot take actions, degrade Dexterity by 2) |
| Plague Cloud | _A cloud of plague spreads_ | Target suffers Diseased (Degrade Constitution by 2, degrade all saves by 2, On turn end, Deal 1d4 necrotic damage to self) |
| Planar Rift | _A rift to another plane opens_ | Planeshift target to =oneOf(Limbo, Pandemonium, Mechanus) |
| Poison Cloud | _A cloud of poison gas swirls into the room_ | Deal 1d4 poison damage to target |
| Poison Darts | _Darts coated in poison shoot out_ | Deal 2d6 poison damage to target |
| Poison Gas | _A cloud of poison gas fills the area_ | Deal 3d6 poison damage to target |
| Poison Mist | _A mist of poison fills the area_ | Deal 7d6 poison damage to target |
| Poisoned Spikes | _Spikes coated in poison shoot up_ | Deal 2d6 piercing damage to target; Deal 1d6 poison damage to target |
| Psychic Rune | _A rune glows with psychic energy_ | Deal 4d6 psychic damage to target |
| Psychic Scream | _A psychic scream assaults the mind_ | Deal 2d6 psychic damage to target |
| Psychic Wave | _A wave of psychic energy washes over_ | Deal 3d6 psychic damage to target |
| Radiant Burst | _A burst of radiant energy explodes_ | Deal 3d6 radiant damage to target |
| Radiant Flash | _A blinding flash of radiant light shines_ | Deal 2d6 radiant damage to target |
| Radiant Rune | _A rune glows with radiant energy_ | Deal 4d6 radiant damage to target |
| Radiant Surge | _A surge of radiant energy bursts forth_ | Deal 8d6 radiant damage to target |
| Scything Blade | _A scything blade swings through the air_ | Deal 2d8 slashing damage to target |
| Shadow Bolt | _A bolt of shadow energy strikes_ | Deal 7d6 necrotic damage to target |
| Shadow Grasp | _Shadows reach out to grasp_ | Target suffers Hexed (Degrade all rolls by 2, degrade all saves by 2); Target suffers Slow (Degrade Dexterity by 5, degrade initiative by 10, degrade attacks per turn by 1) |
| Shock Wave | _A wave of shock energy reverberates_ | Deal 6d6 lightning damage to target |
| Silence Rune | _A rune glows with silencing energy_ | Target suffers Silence (Cannot cast spells) |
| Silencing Field | _A field of silence envelops_ | Target suffers Silence (Cannot cast spells) |
| Sleep Gas | _A gas of sleep spreads_ | Target suffers Asleep (Cannot take actions) |
| Sleep Rune | _A rune glows with soporific energy_ | Target suffers Asleep (Cannot take actions) |
| Sonic Boom | _A booming sonic wave reverberates_ | Deal 2d6 sonic damage to target |
| Sonic Rune | _A rune glows with sonic energy_ | Deal 3d6 sonic damage to target |
| Sonic Wave | _A wave of sonic energy erupts_ | Deal 1d8 sonic damage to target |
| Spike Trap | _Spikes shoot up from the ground_ | Deal 2d6 piercing damage to target |
| Spinning Blade | _A blade spins rapidly_ | Deal 3d8 slashing damage to target |
| Spore Burst | _A burst of spores erupts_ | Target suffers Poison (On turn end, Deal 1d4 true damage to self); Target suffers Diseased (Degrade Constitution by 2, degrade all saves by 2, On turn end, Deal 1d4 necrotic damage to self); Target suffers Slow (Degrade Dexterity by 5, degrade initiative by 10, degrade attacks per turn by 1) |
| Stun Rune | _A rune glows brightly_ | Target suffers Stunned (Cannot take actions, degrade all rolls by 2) |
| Stunning Dart | _A stunning dart shoots out_ | Deal 1d3 piercing damage to target; Target suffers Stunned (Cannot take actions, degrade all rolls by 2) |
| Sunburst | _A sudden burst of sunlight blinds and marks you_ | Deal 2d6 radiant damage to target; Target suffers Sunmarked (Degrade Save versus Magic by 1, 25% vulnerability to Fire, 25% vulnerability to Radiant, On attacked, Deal 1d4 radiant damage to self) |
| Telekinetic Push | _A telekinetic push knocks back_ | Target suffers Prone (Cannot take actions, degrade Dexterity by 2) |
| Thunder Clap | _A clap of thunder reverberates_ | Deal 5d6 lightning damage to target |
| Thunder Strike | _A strike of thunder crashes down_ | Deal 8d6 lightning damage to target |
| Time Dilation | _Time dilates unnaturally_ | Target suffers Slow (Degrade Dexterity by 5, degrade initiative by 10, degrade attacks per turn by 1) |
| Time Warp | _Time warps unpredictably_ | Target suffers Slow (Degrade Dexterity by 5, degrade initiative by 10, degrade attacks per turn by 1); Target suffers Weakened (Degrade Strength by 2, degrade bonus damage by 2); Target suffers Confused (Actions are random) |
| Vine Snare | _Vines erupt to entangle_ | Deal 2d6 slashing damage to target; Target suffers Entangled (Degrade Dexterity by 5, degrade to hit by 2, degrade evasion by 5, degrade initiative by 5) |
| Vine Whip | _A whip of vines lashes out_ | Deal 4d6 slashing damage to target; Target suffers Entangled (Degrade Dexterity by 5, degrade to hit by 2, degrade evasion by 5, degrade initiative by 5) |
